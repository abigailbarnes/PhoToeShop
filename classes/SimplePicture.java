...
public class SimplePicture implements DigitalPicture
{
 ...
 /**
   ...
   */
  public Pic scale(double rFactor, double cFactor)
  {
    ...
    Pic result = new Pic((int) (getHeight() * rFactor),
   ...
   * @return the resulting picture
   */
  public Pic getPictureWithWidth(int width)
  {
    // set up the scale tranform
    double xFactor = (double) width / this.getWidth();
    Pic result = scale(xFactor,xFactor);
    return result;
  }
   ...
   * @return the resulting picture
   */
  public Pic getPictureWithHeight(int height)
  {
    // set up the scale tranform
    double yFactor = (double) height / this.getHeight();
    Pic result = scale(yFactor,yFactor);
    return result;
  }
